<?php
	...
	if(!isset($_POST['request'])){
	...
	} else if ($_POST['request'] == "exchange"){
		$to = "granados@yahoo-inc.com";
		...
		$headers .= "MIME-Version: 1.0\r\n";
		$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
	} else if ($_POST['request'] == "review"){
		$to = "granados@yahoo-inc.com";
		$subject = "Request Review Workshop";
		$message = '<html><body>';
		$message .= "<p>Hi Y! University Admin,</p><br>";
		$message .= "<p><b>".$_POST['username']."</b> has requested the review a workshop</p><br>";;
		$message .= "<img src='http://50.97.99.152/~tracking/img/logo-email.png'/><br>";
		$message .= "<small>Message sent by Credit Tool Administrator</small>";
		$message .= '</body></html>';
		$headers  = "From:".$_POST['email']."\r\n";
